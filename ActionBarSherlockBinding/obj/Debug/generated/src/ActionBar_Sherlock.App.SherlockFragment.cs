...
namespace ActionBar_Sherlock.App {
	...
	[global::Android.Runtime.Register ("com/actionbarsherlock/app/SherlockFragment", DoNotGenerateAcw=true)]
	public partial class SherlockFragment : global::Android.Support.V4.App.Fragment, global::Android.Support.V4.App._ActionBarSherlockTrojanHorse.IOnCreateOptionsMenuListener, global::Android.Support.V4.App._ActionBarSherlockTrojanHorse.IOnOptionsItemSelectedListener, global::Android.Support.V4.App._ActionBarSherlockTrojanHorse.IOnPrepareOptionsMenuListener {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/actionbarsherlock/app/SherlockFragment", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (SherlockFragment); }
		}

		protected SherlockFragment (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		[Register (".ctor", "()V", "")]
		public SherlockFragment () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			if (GetType () != typeof (SherlockFragment)) {
...
#pragma warning disable 0169
		...
		{
			SherlockFragment __this = Java.Lang.Object.GetObject<SherlockFragment> (native__this, JniHandleOwnership.DoNotTransfer);
