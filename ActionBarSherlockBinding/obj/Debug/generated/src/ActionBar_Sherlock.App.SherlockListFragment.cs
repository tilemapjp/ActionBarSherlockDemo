...
namespace ActionBar_Sherlock.App {
	...
	[global::Android.Runtime.Register ("com/actionbarsherlock/app/SherlockListFragment", DoNotGenerateAcw=true)]
	public partial class SherlockListFragment : global::Android.Support.V4.App.ListFragment, global::Android.Support.V4.App._ActionBarSherlockTrojanHorse.IOnCreateOptionsMenuListener, global::Android.Support.V4.App._ActionBarSherlockTrojanHorse.IOnOptionsItemSelectedListener, global::Android.Support.V4.App._ActionBarSherlockTrojanHorse.IOnPrepareOptionsMenuListener {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/actionbarsherlock/app/SherlockListFragment", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (SherlockListFragment); }
		}

		protected SherlockListFragment (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		[Register (".ctor", "()V", "")]
		public SherlockListFragment () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			if (GetType () != typeof (SherlockListFragment)) {
